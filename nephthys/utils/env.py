...
class Environment:
    def __init__(self):
        ...
        self.ai_base_url = os.environ.get("HACK_CLUB_AI_BASE_URL", "https://ai.hackclub.com/proxy/v1")
        self.ai_title_model = os.environ.get("AI_TITLE_MODEL", "openai/gpt-oss-120b")
        self.ai_tag_model = os.environ.get("AI_TAG_MODEL", "google/gemini-3-flash-preview")

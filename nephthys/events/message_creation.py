            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "You will return no other content. You will return no other content. Do NOT use title case but use capital letter at start of sentence + use capital letters for terms/proper nouns."
